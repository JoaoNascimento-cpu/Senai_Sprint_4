...
const TOGGLE_USER_DETAILS_PAYLOAD = 'TOGGLE_USER_DETAILS_PAYLOAD'; // reducer
...
class Result extends Component {
  render() {
    ...
    }, /*#__PURE__*/React.createElement("h4", null, result.login)), /*#__PURE__*/React.createElement("div", {
      className: "clearfix"
    })));
  }
...
class Results extends Component {
  render() {
    ...
    const renderedResults = results.map((result, index) => /*#__PURE__*/React.createElement(Result, {
      key: index,
      result: result,
      onFetchUser: onFetchUser
    }));
    return /*#__PURE__*/React.createElement("div", null, !failure && renderedResults, failure && /*#__PURE__*/React.createElement("p", {
...
class SearchPage extends Component {
  render() {
    ...
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(InputSearch, {
      query: query,
      fetching: fetching,
      onQueryChange: onQueryChange,
      onSearch: onSearch
    }), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement(Results, {
      onFetchUser: onFetchUser,
      results: results,
      failure: failure
    }));
...
class UserDetails extends Component {
  render() {
    ...
    }, "avatar_url" in userDetails && /*#__PURE__*/React.createElement("div", {
      className: "col-xs-12"
    }, /*#__PURE__*/React.createElement("img", {
      className: "img-responsive",
      src: userDetails.avatar_url
    })), "name" in userDetails && /*#__PURE__*/React.createElement("div", {
      className: "col-xs-12"
    }, /*#__PURE__*/React.createElement("h2", null, /*#__PURE__*/React.createElement("a", {
      href: userDetails.html_url ? userDetails.html_url : '#'
    }, userDetails.name), /*#__PURE__*/React.createElement("small", null, "(", userDetails.login, ")"))), "company" in userDetails && /*#__PURE__*/React.createElement("div", {
      className: "col-xs-12"
    }, /*#__PURE__*/React.createElement("h3", null, userDetails.company)), "blog" in userDetails && /*#__PURE__*/React.createElement("div", {
      className: "col-xs-12"
    }, /*#__PURE__*/React.createElement("h4", null, /*#__PURE__*/React.createElement("a", {
      href: userDetails.blog
    }, userDetails.blog))), "email" in userDetails && /*#__PURE__*/React.createElement("div", {
      className: "col-xs-12"
    }, /*#__PURE__*/React.createElement("h4", null, userDetails.email)), "location" in userDetails && /*#__PURE__*/React.createElement("div", {
      className: "col-xs-12"
    }, /*#__PURE__*/React.createElement("h3", null, userDetails.location)), "bio" in userDetails && /*#__PURE__*/React.createElement("div", {
      className: "col-xs-12"
    }, /*#__PURE__*/React.createElement("p", null, userDetails.bio)), "followers" in userDetails && /*#__PURE__*/React.createElement("div", {
      className: "col-xs-6"
    }, /*#__PURE__*/React.createElement("h4", null, "Followers: ", userDetails.followers)), "following" in userDetails && /*#__PURE__*/React.createElement("div", {
      className: "col-xs-6"
    }, /*#__PURE__*/React.createElement("h4", null, "Following: ", userDetails.following)), "public_repos" in userDetails && /*#__PURE__*/React.createElement("div", {
      className: "col-xs-6"
    }, /*#__PURE__*/React.createElement("h4", null, "Repos: ", userDetails.public_repos)), "public_gists" in userDetails && /*#__PURE__*/React.createElement("div", {
      className: "col-xs-6"
    }, /*#__PURE__*/React.createElement("h4", null, "Gists: ", userDetails.public_gists)), userDetails && /*#__PURE__*/React.createElement("div", {
      className: "col-xs-12"
    }, /*#__PURE__*/React.createElement("h4", null, /*#__PURE__*/React.createElement("a", {
      className: "link-hover-hand",
      onClick: () => toggleDetailsPayload()
    }, "Click for Full Payload with Repos:")), showFullDetailsPayload && /*#__PURE__*/React.createElement("pre", null, JSON.stringify(userDetailsSansRepos, undefined, 2))));
  }
...
class RepoListItem extends Component {
  render() {
    ...
    }, repoDetails.name), /*#__PURE__*/React.createElement("div", {
      className: "col-xs-4 col-sm-3 col-md-3 col-lg-3"
    }, /*#__PURE__*/React.createElement("span", {
      className: "badge"
    }, repoDetails.language)), /*#__PURE__*/React.createElement("div", {
      className: "clearfix"
    }))), "description" in repoDetails && repoDetails.description != "" && /*#__PURE__*/React.createElement("div", {
      className: "panel-body"
    }, /*#__PURE__*/React.createElement("p", null, repoDetails.description))));
  }
...
class UserRepoList extends Component {
  render() {
    ...
    const repoListTags = userDetails.repo_list.map(item => /*#__PURE__*/React.createElement(RepoListItem, {
      repoDetails: item
    }));
    return /*#__PURE__*/React.createElement("div", {
      className: "col-xs-12 col-sm-12 col-md-8 col-lg-8"
    }, /*#__PURE__*/React.createElement("h3", null, " List of User's Repositories "), /*#__PURE__*/React.createElement("ul", {
...
class UserPage extends Component {
  render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: "row"
    }, fetchingUser && /*#__PURE__*/React.createElement("div", {
    ...
    }), /*#__PURE__*/React.createElement(UserRepoList, {
      userDetails: userDetails,
      failureUser: failureUser,
      fetchingUser: fetchingUser
    })));
...
class App extends Component {
  render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "jumbotron"
    }, !params.username && /*#__PURE__*/React.createElement(SearchPage, {
      query: query,
      fetching: fetching,
      onQueryChange: onQueryChange,
      onFetchUser: onFetchUser,
      ...
      results: results,
      failure: failure
    }), params.username && /*#__PURE__*/React.createElement(UserPage, {
      fetchingUser: fetchingUser,
      onFetchUser: onFetchUser,
      failureUser: failureUser,
      userDetails: userDetails,
...
const AppContainer = connect(mapStateToProps, mapDispatchToProps)(App); // create store using middlewares
...
let store = createStore(rootReducer, composeEnhancers(applyMiddleware(ReduxThunk)));
const appHistory = syncHistoryWithStore(hashHistory, store); // render the app to the page
